"""
Tests for Image Captioning CNN-LSTM — validates config and file structure.
Run: pytest tests/
"""
import pytest
import os
...
def test_setup_script_exists():
    """setup_data.sh must exist."""
    import pathlib
    script = pathlib.Path(__file__).parent.parent / "setup_data.sh"
    assert script.exists(), "setup_data.sh not found"
